...
<button onclick.prevent="$dispatch('open-modal', 'confirm-user-deletion')">Delete Account</button>
...
<form method="post" action="{{ route('profile.destroy') }}">
    ...
    <p>Once your account is deleted, all of its resources and data will be permanently deleted. Please
        ...
        <input id="password" type="text" name="password" type="password" placeholder="Password">
